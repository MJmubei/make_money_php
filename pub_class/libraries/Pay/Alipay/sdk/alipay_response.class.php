...
class nl_alipay_response
{
    ...
    protected static $bussiness_code   = array(
    ...
    protected static $default_response = array(
        'code'     => 10000,
        'msg'      => '',
        'data'     => array(),
    );

    protected static $default_response_data = array(
        'out_trade_no'         => '',
        'fund_channel'         => '',
    ...
    public static function parse($request_name, $response)
    {
        $request_name = str_replace(".", "_", $request_name)."_response";
    ...
    protected static function get_msg_by_bussiness_code($code)
    {
