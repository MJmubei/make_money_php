...
/**
 * Created by PhpStorm.
 * Use : 计算/设置/获取签名、输出xml格式的参数、从xml读取数据对象
...
class WxPayResults extends WxPayDataBase
{
	...
	public function CheckSign()
	{
		...
		if(!$this->IsSignSet()){
			// 新疆电信网通支付回调数据和原始的不一致
			if (!isset($this->values['sign']) && isset($this->values['encryption']))
			{
				$this->values['sign'] = $this->values['encryption'];
				unset($this->values['encryption']);
			}
			else
			{
 ...
 *
 */
class WxPayContractOrder extends WxPayDataBase
{
	/**
	 * 设置微信分配的公众账号ID
	 * @param string $value
	...
	{
		return $this->values['plan_id'];
	}
	/**
	 * 协议模板id
	 * @return true 或 false
	 **/
	public function IsPlan_idSet()
	{
		return array_key_exists('plan_id', $this->values);
	}
	 ...
	 * @return string
	 **/
	public function GetContract_code()
	{
		return $this->values['contract_code'];
	}
	/**
	 * 签约协议号
	 * @return true 或 false
	 **/
	public function IsContract_codeSet()
	{
		return array_key_exists('contract_code', $this->values);
	}

	/**
	 *  请求序列号 商户请求签约时的序列号,商户侧须唯一
	 * @param string $value
	 **/
	 ...
	 * @return string
	 **/
	public function GetRequest_serial()
	{
		return $this->values['request_serial'];
	}
	/**
	 *  请求序列号 商户请求签约时的序列号,商户侧须唯一
	 * @return true 或 false
	 **/
	public function IsRequest_serialSet()
	{
		return array_key_exists('request_serial', $this->values);
	}
	 ...
	 * @return string
	 **/
	public function GetContract_display_account()
	{
		return $this->values['contract_display_account'];
	}
	/**
	 *  用户账户展示名称 签约用户的名称,用于页面展示，参数值不支持UTF8非3字节编码的字符，例如表情符号，所以请勿传微信昵称到该字段
	 * @return true 或 false
	 **/
	public function IsContract_display_account()
	{
		return array_key_exists('contract_display_account', $this->values);
	}
	 ...
	 * @return string
	 **/
	public function GetContract_notify_url()
	{
		return $this->values['contract_notify_url'];
	}
	/**
	 *  签约信息回调通知的url
	 * @return true 或 false
	 **/
	public function IsContract_notify_url()
	{
		return array_key_exists('contract_notify_url', $this->values);
	}
}
 ...
 *
 */
class WxPayDeleteContract extends WxPayDataBase
{
	/**
	 * 设置微信分配的公众账号ID
	 * @param string $value
	...
	/**
	 * 协议模板id 商户在微信商户平台配置的代扣模版id，选择plan_id+contract_code解约，则此参数必填
	 * @param string $value
	 **/
	public function SetPlan_id($value)
	{
	...
	/**
	 * 签约协议号 商户请求签约时传入的签约协议号，商户侧须唯一。选择plan_id+contract_code解约，则此参数必填
	 * @param string $value
	 **/
	public function SetContract_code($value)
	{
	...
	/**
	 * 委托代扣协议id 委托代扣签约成功后由微信返回的委托代扣协议id，选择contract_id解约，则此参数必填
	 * @param string $value
	 **/
	 ...
	 * @param string $value
	 **/
	public function SetContract_termination_remark($value)
	{
		$this->values['contract_termination_remark'] = $value;
	}
	/**
	 * 解约备注 解约原因的备注说明，如：签约信息有误，须重新签约
	 * @return string
	 **/
	public function GetContract_termination_remark()
	{
		return $this->values['contract_termination_remark'];
	}
	/**
	 * 解约备注  解约原因的备注说明，如：签约信息有误，须重新签约
	 * @return true 或 false
	 **/
	public function IsContract_termination_remarkSet()
	{
		return array_key_exists('contract_termination_remark', $this->values);
	}
 ...
 *
 */
class WxPayPapPayApply extends WxPayDataBase
{
	/**
	 * 设置微信分配的公众账号ID
	 * @param string $value
	...
	{
		return $this->values['outerid'];
	}
	/**
	 *  商户侧用户标识
	 * @return true 或 false
	 **/
	public function IsOuteridSet()
	{
		return array_key_exists('outerid', $this->values);
	}
}