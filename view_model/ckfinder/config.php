 ...
 */
$baseUrl = "/CodeIgniter/data_model/";
/*
...
$config['ResourceType'][] = Array(
    'name' => 'Log', // Single quotes not allowed
    'url' => $baseUrl,
    'directory' => $baseDir,
    'maxSize' => 0,
    'allowedExtensions' => 'xml,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions' => '');
