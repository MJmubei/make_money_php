$(document).ready(function () {
    ...
    function switchTheme(themeName) {
    	if (themeName == 'classic') {
            $('#bs-css').attr('href', '../../../../view_model/backstage/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', '../../../../view_model/backstage/css/bootstrap-' + themeName + '.min.css');
        }
