...
class em_logic
{
    ...
    {
        $this->str_base_table = (substr($table_name, 0,3)=='em_') ? $table_name : "em_".$table_name;
    ...
    public function make_query_sql($params,$limit)
    {
     ...
     * @date 2015-09-07
     */
    public function make_page_limit($page_info)
    {
        if(isset($page_info['page_count']))
        {
            ...
            return " limit ".$this->page_info['page_count'];
        }
        ...
        $str_start = ($this->page_info['page_num'] - 1) * $this->page_info['page_size'];
        return " limit {$str_start} , ".$this->page_info['page_size'];
    }
