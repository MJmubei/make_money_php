...
class c_logic_model extends CI_Controller
{
    ...
    {
        $this->load_view_file($this->auto_load_table('admin_system', 'l_admin', 'query_tables'),__LINE__);
    }
    ...
    public function make_logic_model()
    {
        ...
        {
            $table_val = (substr($table_val, 0,3)=='em_') ? $table_val : "em_".$table_val;
	        $result_data = $this->auto_load_table('admin_system', 'l_admin', 'query_table_fileds',array('table_name'=>$table_val));
