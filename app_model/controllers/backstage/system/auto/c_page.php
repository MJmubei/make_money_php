...
class c_page extends CI_Controller
{
    ...
    public function index()
    {
        $system_file_list = array(
            array(
                'url'=>'system/auto/c_page/add.php',
                'class'=>'system_auto_c_page_add',
                'ajax'=>'system/auto/c_page/add',
                'function'=>'add',
                'button_data'=>array( 
                    array(
                        'name'=>'添加',
            ...
            array(
                'url'=>'system/auto/c_page/edit.php',
                'class'=>'system_auto_c_page_edit',
                'ajax'=>'system/auto/c_page/edit',
                'function'=>'edit',
                'button_data'=>array(
                    array(
                        'name'=>'修改',
