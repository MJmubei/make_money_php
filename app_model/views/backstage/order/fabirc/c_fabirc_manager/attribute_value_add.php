	...
	<div class="modal-dialog modal-lg" >
		<div class="modal-content animated bounceInTop">
			...
			<div class="modal-body">
                <form id="<?php echo $system_file_list_value['class'];?>-form" method="post" action="" >
                	...
                	<div class="form-group">
                		<label class="col-md-2 control-label">属性值名称</label>
                		<div class="col-md-10">
            ...
            <div class="modal-footer">
                <div class="form-body">
                    <span>
                		<button class="btn purple" type="button" onclick="sys_sweetalert('submit','<?php echo $system_file_list_value['class'];?>','您确定要添加这条信息吗','提交数据后系统将可能会添加此条数据，请谨慎操作！','<?php echo $system_file_list_value['ajax'];?>','',true,'./fabirc_attribute_list?cms_fabirc_attribute_id=<?php echo $attribute_id;?>');">
