			...
			<div class="modal-body">
                <form id="<?php echo $system_file_list_value['class'];?>-form" method="post" action="" >
                	<div class="form-group">
                		<label class="col-md-2 control-label">面辅料名称</label>
                		<div class="col-md-10">
                	...
                	<div class="form-group">
                		...
                		<div class="col-md-10">
                			<div class="input-group input-icon right">
                                <label><input type="radio" checked value="0" name="cms_is_scarce" />普通</label>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label><input type="radio" value="1" name="cms_is_scarce" />奇缺</label>
                			</div>
                		</div>
                	</div>
                	<div class="form-group">
