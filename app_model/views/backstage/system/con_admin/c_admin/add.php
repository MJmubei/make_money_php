                        ...
                        <div class="validation-form">
                            ...
                            <form>
                                <div class="form-group1">
                                    ...
                                    <div class="col-sm-7 form-group2 group-mail">
                                        <input type="email" class="form-control" id="inputEmail3" placeholder="Current Website Url" >
                                    </div>
                                    <div class="clearfix"></div><hr/>
                                    <div class="col-sm-2">
...
<?php include_once dirname(dirname(dirname(dirname(dirname(__FILE__))))).'/model/backstage/pub_foot_web_file.php';?>
</body>
</html>