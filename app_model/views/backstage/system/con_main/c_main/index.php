			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class=" row">
					<div class="col-md-3 col-sm-3 col-xs-6">
						<a data-toggle="tooltip" title="新入职员工 60." class="well top-block" href="#"> 
						    <i class="glyphicon glyphicon-user blue"></i>
							<div>员 工 人 数</div>
							<div>507</div> 
							<span class="notification">60</span>
						</a>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-6">
						<a data-toggle="tooltip" title="用户在线量 23 623." class="well top-block" href="#"> 
						     <i class="glyphicon glyphicon-star green"></i>
							 <div>用 户 人 数</div>
							 <div>2 074 532</div> <span class="notification green">23 623</span>
						</a>
					</div>

					<div class="col-md-3 col-sm-3 col-xs-6">
						<a data-toggle="tooltip" title="新销售额 343176." class="well top-block" href="#"> 
						    <i class="glyphicon glyphicon-shopping-cart yellow"></i>
							<div>销 售 金 额</div>
							<div>￥13 320 121 216</div> 
							<span class="notification yellow">￥343 176</span>
						</a>
					</div>

					<div class="col-md-3 col-sm-3 col-xs-6">
						<a data-toggle="tooltip" title="未处理消息 120." class="well top-block" href="#"> 
							...
							<div class="box-content row">
								<div class="col-lg-7 col-md-12">
									...
									<p class="center-block download-buttons">
										<a href="#" class="btn btn-primary btn-lg"><i class="glyphicon glyphicon-chevron-left glyphicon-white"></i> Back to article</a> 
										<a href="#" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-download-alt"></i> Download Page</a>
									</p>
								</div>
							</div>
						</div>
					...
					<div class="box col-md-4">
						<div class="box-inner homepage-box">
							...
							<div class="box-content">
								...
								<p>
									You may like my other open source work, check my profile on GitHub.
								</p>
