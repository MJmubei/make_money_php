		...
		<div class="left-content">
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<h3 class="inner-tittle two">管理员列表</h3>
					<div class="graph">
						<div class="form-body">
							<form class="form-horizontal" method="post" action="<?php echo $arr_page_url['list_url'];?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-1">
    									<button class="btn green" type="button" id="button_query_list">
								...
								<tbody>
								    ...
								    ?>
        										<tr class='odd selected'>
        											...
        											<td><?php echo $val['cms_login_account'];?></td>
        											<td><?php echo $val['cms_login_pass'];?></td>
        											<td><?php echo $val['cms_role_id'];?></td>
        											<td><?php echo $val['cms_login_count'];?></td>
        											<td><?php echo $val['cms_login_time'];?></td>
        											<td><?php echo $val['cms_state'];?></td>
        											<td><?php echo $val['cms_deleted'];?></td>
        											...
        											<td>
                                                        <div class="dropdown">
            												...
            												<ul class="dropdown-menu float-right">
            												    <li>
            													   <a href="../../con_admin/c_logic_model/make_logic_model?cms_id=<?php echo $val['cms_id'];?>" title=""> 
